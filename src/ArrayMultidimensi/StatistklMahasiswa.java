...
public class StatistklMahasiswa {
    ...
    public static void mhsPerAngkatanPerJK(int[][][] _jumlahMahasiswa, String[] _jk, int _angkatan, int _jK) {
        int jumlahMahasiswa = 0;
        for (int[][] _jumlahMahasiswa1 : _jumlahMahasiswa) {
            jumlahMahasiswa += _jumlahMahasiswa1[_angkatan-1][_jK - 1];
        }
        System.out.println("Jumlah Mahasiswa angkatan " + (_angkatan-1) + " dengan jenis kelamin " +_jk[_jK-1] + " sejumlah : " + jumlahMahasiswa);
    }
     public static void mhsPerProdiPerJK(int[][][]_jumlahMahasiswa,String[] _Prodi, int prodi, int _jK, String[] _jk){
        int jumlahMahasiswa = 0;
         ...
         for (int k = 0; k < _jumlahMahasiswa[0].length; k++) {
               jumlahMahasiswa += _jumlahMahasiswa[prodi-1][k][_jK-1];
          
        }
        System.out.println("Jumlah Mahasiswa Prodi" + _Prodi[prodi-1] + " dengan jenis kelamin " +_jk[_jK-1] + " sejumlah : " + jumlahMahasiswa);
    }
